...
describe('User Repository Abstract', () => {
    it('it should return awaited value when register user', () => {
        ...
        expect(() => UserRepository.register({username: 'ripanrenaldi', password: 'rahasia', name: 'ripanrenaldi', role: 'admin'})).rejects.toThrowError('ABSTRACT_CLASS.METHOD_NOT_IMPLEMENTED')
